  ...
  var XLSX = {};
    (function make_xlsx(XLSX) {
        ...
        function write_numFmts(NF, opts) {
            ...
            //return o.join("");
            [[1, 5], [9, 24], [37, 40], [45, 49], [56, 56]].forEach(function (r) {
        ...
        function write_sty_xml(wb, opts) {
            ...
            o[o.length] = ('<fonts count="7"><font><sz val="11.0"/><color indexed="8"/><name val="宋体"/><family val="2"/><scheme val="minor"/><charset val="1"/></font>');
            ...
            o[o.length] = ('<font><name val="Microsoft YaHei UI"/><sz val="10.0"/><color rgb="2C4D79"/><b/></font>');
        ...
        function write_ws_xml_frozen(ws, frozen) {
            var o = ["<sheetViews><sheetView workbookViewId=\"0\" tabSelected=\"1\">"], col, width;
            ...
            //};
            //o[o.length] = writextag('pane', null, p);
            //var selection = { pane: "topRight" ,activeCell:"B1" ,sqref:"B1" };
            //o[o.length] = writextag('selection', null, selection);
            //var selection1 = { pane: "bottomLeft", activeCell: "A3", sqref: "A3" };
            //o[o.length] = writextag('selection', null, selection1);
            //var selection2 = { pane: "bottomRight", activeCell: "B3", sqref: "B3" };
            //o[o.length] = writextag('selection', null, selection2);
            //o[o.length] = "</sheetView>";
            //o[o.length] = "</sheetViews>";
            return o.join("");
        }
        ...
        function write_ws_xml(idx, opts, wb, rels) {
            ...
            if (ws['!frozen'] !== undefined)
                o[o.length] = (write_ws_xml_frozen(ws, ws['!frozen']));
